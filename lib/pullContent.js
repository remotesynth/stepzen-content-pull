    ...
    let req = https.request(options, (res) => {
      ...
      res.on('end', () => {
        ...
        if (fileType === 'json') {
          ...
          if (fileType !== 'json' && fileType !== 'md' && fileType !== 'yaml' && fileType !== 'markdown'){
            throw new Error('Unsupported file type. stepzen-content-pull currently only supports files of these types: json, md, and yaml')
          }
        }
      });
    });
